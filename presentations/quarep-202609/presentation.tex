...
\begin{frame}
  ...
  A LinkML schema is a YAML file organized in 3 sections:
  \begin{itemize}
    \item A preamble
      \begin{itemize}
...
\hspace{1em}\textcolor<2>{red}{LiMiObjective}:

\hspace{2em}\textcolor<3>{red}{description: The microscope's Objective lens consists of a}

\hspace{3em}\textcolor<3>{red}{lens, its mount, and any associated part [...]}

\hspace{2em}attributes:

\hspace{3em}\textcolor<4>{red}{magnification}:

\hspace{4em}\textcolor<5>{red}{description: The magnification of the objective as}

\hspace{5em}\textcolor<5>{red}{specified by the manufacturer - i.e., 60 represents}

\hspace{5em}\textcolor<5>{red}{a 60X lens.}

\hspace{4em}\textcolor<6>{red}{range: float}

\hspace{3em}\textcolor<4>{red}{correction}:

\hspace{4em}\textcolor<5>{red}{description: The type of optical correction associated}

\hspace{5em}\textcolor<5>{red}{with this Objective.}

\hspace{4em}\textcolor<6>{red}{range: LiMiObjectiveCorrectionType}
\end{semiverbatim}
\end{frame}
...
\hspace{1em}\textcolor<2>{red}{LiMiObjectiveCorrectionType}:

\hspace{2em}\textcolor<3>{red}{description: The type of optical correction associated}

\hspace{3em}\textcolor<3>{red}{associated with an objective.}

\hspace{2em}permissible\_values:

\hspace{3em}\textcolor<4>{red}{Achro}:

\hspace{3em}\textcolor<4>{red}{Achromat}:

\hspace{3em}\textcolor<4>{red}{Achroplan}:
...
\begin{frame}
  ...
  Defining an enumeration using \textcolor<4>{red}{ontology terms}.

\begin{semiverbatim}
enums:

\hspace{1em}\textcolor<2>{red}{Organism}:

\hspace{2em}description: The organism a sample comes from.

\hspace{2em}\textcolor<3>{red}{reachable\_from}:

\hspace{3em}source\_ontology: \textcolor<4>{red}{obo:NCBITaxon}

\hspace{3em}source\_nodes:

\hspace{4em}- \textcolor<4>{red}{NCBITaxon:131567} \# cellular organism
...
\begin{frame}
  ...
  \begin{itemize}
    \item \textcolor<2>{red}{Comments}: intended for the users of the schema
    \item \textcolor<4>{red}{Notes}: intended for the editors of the schema
  \end{itemize}
...
\hspace{5em}- \textcolor<2>{red}{The value is typically expected to be 0.02 - 1.5.}
\end{semiverbatim}}
...
\hspace{5em}- \textcolor<4>{red}{FIXME This should not be needed? If there is no}

\hspace{6em}\textcolor<4>{red}{Correction Collar, then the correction\_collar\_type}

\hspace{6em}\textcolor<4>{red}{attribute can simply be left unset.}
\end{semiverbatim}}
  \end{overlayarea}
\end{frame}
...
\begin{frame}
  ...
  Any element in a LinkML schema can be annotated with \textcolor<2>{red}{custom,
...
\hspace{5em}\textcolor<2>{red}{tier: 1}

\hspace{5em}\textcolor<2>{red}{recommended\_in\_mm\_section: true}
\end{semiverbatim}
...
\begin{frame}
  ...
  \begin{block}{}
    ...
    model for all downstream usages
  \end{block}
\end{frame}
